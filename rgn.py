...
def on_mqtt_connect(client, userdata, flags, rc):
    if rc == 0:
        ...
        mqtt_client_cloud.subscribe("request_topic_rgn")
    else:
...
def on_mqtt_connect_mec(client, userdata, flags, rc):
    if rc == 0:
        ...
        mqtt_client_mec.subscribe("request_topic_rgn")
...
async def connect_to_cloud_nats(server_url: str) -> str:
    ...
    for i in range(retries):
        try:
            ...
            await nc_cloud.subscribe("request_topic_rgn", cb=response_handler)
...
#               msg.Respond(timeAsBytes)
            ...
            await nc_mec.subscribe("request_topic_rgn", cb=mec_message_handler)
